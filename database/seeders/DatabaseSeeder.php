...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $descriptions = [
            'ar' => 'Son fusies diseñados para el combate, de fuego selectivo (automático/semiautomático) siendo el arma de infantería estándar en la mayoría de los ejércitos modernos. Han reemplazado o complementado ampliamente a los más grandes y potentes fusiles de fusiles de tirador.',
